        ...
        <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 text-center">
            <div className="max-w-4xl space-y-8 animate-in fade-in duration-700">
                ...
                <div className="flex flex-col md:flex-row gap-4 justify-center items-center pt-8">
                    <button onClick={() => navigate('/verify')} className="w-full md:w-auto px-8 py-4 bg-white text-black font-bold rounded-full text-lg hover:scale-105 transition active:scale-95">
                        Verify a Certificate
                    </button>
                    <button onClick={() => navigate('/dashboard')} className="w-full md:w-auto px-8 py-4 bg-yellow-500 text-black font-bold rounded-full text-lg hover:bg-yellow-400 transition flex items-center justify-center gap-2">
