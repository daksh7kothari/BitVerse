    ...
    <div className="space-y-8 animate-fade-in">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="glass-panel p-6 rounded-3xl group hover:border-gold-500/30 transition duration-300">
          ...
          <h4 className="text-4xl font-black mt-2 bg-gradient-to-r from-gold-300 to-gold-600 bg-clip-text text-transparent">{(totalWeight / 1000).toFixed(2)} <span className="text-lg text-gold-500/50 font-normal">Kg</span></h4>
        </div>
